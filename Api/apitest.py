...
#     # Search for the related ratings
...
#     # Example of a logged-in user (replace with actual logic)
#     current_user_id = 1
#     user_rating = next(
...
#     user_list = [
#         {
#             "id": user.id,  # Customized ID format
#             "age": user.age,
...
# def get_book_list():
#     # Retrieve the request parameters
#     user_id = request.args.get('userId')  # The userId parameter (not used here but could be added for logic)
#     sort_criteria = request.args.get('sortCriteria')  # The sortCriteria parameter

#     # Check for the presence of the sortCriteria parameter
#     if not sort_criteria:
#         return jsonify({"error": "Missing sortCriteria parameter"}), 400

#     # Example of dummy data (normally, this would be retrieved from the database)
#     book_list = [
#         {
#             "id": "2",
